INSERT INTO ZAPRIT_USER (ID, EMAIL, USER_NAME, FIRST_NAME, LAST_NAME, PENDING_EMAIL, PASSWORD, ENABLED, ACCOUNT_NON_EXPIRED, ACCOUNT_NON_LOCKED, CREDENTIALS_NON_EXPIRED, CONFIRMATION_TOKEN,SIGNUP_TYPE,COMPANY_ID) VALUES
	('1', 'zadmin@zapritlabs.io', 'admin' , 'vaibhav', 'Singh', null, /*admin1234*/'$2a$08$qvrzQZ7jJ7oy2p/msL4M0.l83Cd0jNsX6AJUitbgRXGzge4j035ha', true, true, true, true, null, 1, 'TestCompanyId1'),
	('2', 'root@zapritlabs.io', 'reader','Groot' , 'Best' ,null, /*reader1234*/'$2a$08$dwYz8O.qtUXboGosJFsS4u19LHKW7aCQ0LXXuNlRfjjGKwj5NfKSe',  true, true, true, true, null, 1, 'TestCompanyId1'),
	('3', 'cyby@zapritlabs.io','modifier','Galvin','Belson', null, /*modifier1234*/'$2a$08$kPjzxewXRGNRiIuL4FtQH.mhMn7ZAFBYKB3ROz.J24IX8vDAcThsG', true, true, true, true, null, 1, 'TestCompanyId2'),
	('4', 'torpedo@zapritlabs.io','reader2','Galvin','Belson', null, /*reader1234*/'$2a$08$vVXqh6S8TqfHMs1SlNTu/.J25iUCrpGBpyGExA.9yI.IlDRadR6Ea', true, true, true, true, null, 1, 'TestCompanyId3');
